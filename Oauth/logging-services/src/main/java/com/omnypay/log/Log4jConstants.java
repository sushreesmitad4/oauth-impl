...
public final class Log4jConstants {
	...
	public static final String LOG_ENTRY_REQUESTPARAM = "Entering in to";
	...
	public static final String PASSWORD_NOT_SENT = "Entered answers are not matching";
	
	public static final String PASSWORD_DATA_TYPE = "Entered data not  matching";
